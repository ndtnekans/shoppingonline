...
import MyContext from '../contexts/MyContext'; //2.2.18.1

class ProductDetail extends Component {
  static contextType = MyContext; // using this.context to access global state    +++  ảnh hưởng đến hoạt động trên import
  constructor(props) {
    super(props);
    this.state = {
      product: null,
